    ...
    return (
        <div>
            ...
            <h6 class="centerText" id="finalTextAtTop">
               ...
               <br />
               I am using New Relic to ping it every 30 seconds, but there is latency in the process, so your post may not be sent. Sorry for the inconvenience if it happens!
            </h6>
            <div class="container">
